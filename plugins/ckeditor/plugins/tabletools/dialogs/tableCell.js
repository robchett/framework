        ...
        {id: "info", label: c.title, accessKey: "I", elements: [
            {type: "hbox", widths: ["40%", "5%", "40%"], children: [
                    ...
                    children: [
                        {type: "hbox", widths: ["70%", "30%"], children: [
                            ...
                            {type: "select", id: "widthType", label: f.lang.table.widthUnit, labelStyle: "visibility:hidden", "default": "px", items: [
                                [g.widthPx, "px"],
                                [g.widthPc, "%"]
                            ], setup: function (a) {(a = j.exec(a.getStyle("width") || a.getAttribute("width"))) && this.setValue(a[2])}}
                        ]},
                        {type: "hbox", widths: ["70%", "30%"], children: [
                            {type: "text",
                ...
                {type: "vbox", padding: 0, children: [
                    ...
                    e,
                    {type: "text", id: "rowSpan", label: c.rowSpan, "default": "", validate: h.integer(c.invalidRowSpan), setup: function (a) {(a = parseInt(a.getAttribute("rowSpan"), 10)) && 1 != a && this.setValue(a)}, commit: function (a) {
                        var b = parseInt(this.getValue(), 10);
                    ...
                    {type: "text", id: "colSpan", label: c.colSpan, "default": "", validate: h.integer(c.invalidColSpan),
                        setup: function (a) {(a = parseInt(a.getAttribute("colSpan"), 10)) && 1 != a && this.setValue(a)}, commit: function (a) {
                        var b = parseInt(this.getValue(), 10);
                    ...
                    {type: "hbox", padding: 0, widths: ["60%", "40%"], children: [
                        ...
                        i ? {type: "button", id: "bgColorChoose", "class": "colorChooser", label: c.chooseColor, onLoad: function () {this.getElement().getParent().setStyle("vertical-align", "bottom")}, onClick: function () {
                    ...
                    {type: "hbox", padding: 0, widths: ["60%", "40%"], children: [
                        ...
                        i ? {type: "button", id: "borderColorChoose", "class": "colorChooser", label: c.chooseColor, style: (k ? "margin-right" : "margin-left") + ": 10px", onLoad: function () {this.getElement().getParent().setStyle("vertical-align", "bottom")}, onClick: function () {
                            f.getColorFromDialog(function (a) {
