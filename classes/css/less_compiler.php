...
class less_compiler extends \classes\css\compiler {
    ...
    protected function tryImport($importPath, $parentBlock, $out) {
        ...
        $root = $parser->parse(file_get_contents($realPath), null, $realPath);
    ...
    public function _compile($string, $name = null) {
        ...
        $root = $this->parser->parse($string, null, $this->source_file);
    ...
    // This is deprecated
    public function parse($str = null, $initialVariables = null, $path = '') {
...
class lessc_parser {
    ...
    public function __construct($lessc, $sourceName = null) {
        ...
        if (!self::$operatorString) {
            self::$operatorString =
                '(' . implode('|', array_map(['\classes\css\less_compiler', 'preg_quote'],
    ...
    public function parse($buffer, $a, $source_file = '') {
        $this->count = 0;
        $this->line = 1;
    ...
    protected function isDirective($dirname, $directives) {
        ...
        $pattern = implode("|",
            array_map(['\\classes\\css\\less_compiler', "preg_quote"], $directives)
        );
    ...
    protected function openString($end, &$out, $nestingOpen = null, $rejectStrs = null) {
        ...
        $stop = ["'", '"', "@{", $end];
        $stop = array_map(['\\classes\\css\\less_compiler', "preg_quote"], $stop);
    ...
    public function block($block) {
        ...
        if (!empty($block->selectors)) {
            ...
            if (_less_compiler::$debug && $block->file) {
                echo '@media -sass-debug-info{filename{font-family:file\:\/\/\/' . str_replace(['C:/', '/', '.'], ['', '\/', '\.'], $block->file) . '}line{font-family:\0000336}}' . "\n";
            }
