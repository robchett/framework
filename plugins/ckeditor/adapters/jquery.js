...
(function (a) {
    ...
    "undefined" != typeof a && (a.extend(a.fn, {ckeditorGet: function () {
        ...
        this.each(function () {
            ...
            i.push(j.promise());
            if (c && !f)g && g.apply(c, [this]), j.resolve(); else if (f)c.once("instanceReady", function () {setTimeout(function () {c.element ? (c.element.$ == h && g && g.apply(c, [h]), j.resolve()) : setTimeout(arguments.callee, 100)}, 0)}, null, null, 9999); else {
                ...
                c.on("instanceReady", function (d) {
                    ...
                    setTimeout(function () {
                        if (e.element) {
                            ...
                            e.on("setData", function (a) {b.trigger("setData.ckeditor", [e, a.data])});
        ...
        a.when.apply(this, i).then(function () {f.resolve()});
        ...
        return function (d) {
            if (arguments.length) {
                ...
                if (i.length) {
                    ...
                    a.when.apply(this, i).done(function () {b.resolveWith(k)});
                    return b.promise()
                }
                return f
            }
