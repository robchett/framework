...
abstract class cms_login_form extends form {
    ...
    public $bootstrap = [0, 12, 'form-horizontal'];
    public $submit_attributes = ['class' => ['btn-block', 'btn-lg']];
    ...
    public function __construct() {
        ...
        $this->pre_fields_text = node::create('h2.form-signin-heading.text-center', [], node::create('small', [], 'Admin Login<br/>') . ini::get('site', 'title_tag'))
                                     ->get();
        $this->submit = 'Login';
        $this->id = 'cms_login';
    }
